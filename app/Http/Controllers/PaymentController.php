...
class PaymentController extends Controller
{
    ...
    public function executepayment()
    {
        ...
        $this->_InsertTransactionInfo($resultdatax);
        echo $resultdatax;
    }
    ...
    protected function _updateOrderStatus($resultdatax)
    {
        ...
        if ($resultdatax && $resultdatax->paymentID != null && $resultdatax->transactionStatus == 'Completed') {
            DB::table('orders')->where([
                ...
                'status' => 'Processing', 'txnID' => $resultdatax->paymentID
            ]);
        }
    }

    protected function _InsertTransactionInfo($resultdatax)
    {
        $resultdatax = json_decode($resultdatax);

        if ($resultdatax && $resultdatax->paymentID != null && $resultdatax->transactionStatus == 'Completed') {
                DB::table('transaction_lists')->insert(
                    [
                    ...
                    'customerMsisdn' => $resultdatax->customerMsisdn
                ]);
